...
namespace Client
{
	...
	{
		m_prefabReferenceUuid = uuids::uuid::from_string(p_prefabReferenceUuid).value();

		return *this;
	}

	EntityBuilder& EntityBuilder::SetPrefabReferenceUuid(const uuids::uuid& p_prefabReferenceUuid)
	{
